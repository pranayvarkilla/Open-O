        ...
        if (printDateRangeNotes) {
            if (jsonobject.containsKey("dates")) {
                ...
                if (datesJson.containsKey("start")) {
                    startCal = jakarta.xml.bind.DatatypeConverter.parseDateTime(datesJson.getString("start"));
                }
                if (datesJson.containsKey("end")) {
                    endCal = jakarta.xml.bind.DatatypeConverter.parseDateTime(datesJson.getString("end"));
                }
            }
