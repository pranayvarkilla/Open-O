...
<div class="container">
    <div class="row">
        ...
        <div class="alert alert-success"><strong>Access elevated.</strong> Your access to documents has been elevated
            temporarily. Switching pages will reset your elevation.
        </div>
        <% } %>
    </div>
    <div class="row">
        <div class="col-md-2">
            ...
            %><a class="list-group-item<%= (folder.getFolder().getUniqueId().equals(request.getParameter("folder"))) ? " active" : ""%>"
                 href="<%=String.format("%s&folder=%s&selectedAffinityDomain=%s&demographic_no=%s", submitUrl, folder.getFolder().getUniqueId(), folder.getAffinityDomainId(), request.getParameter("demographic_no"))%>"><%=folder.getFolder().getTitle()%>
            </a><%
                    }
                }
            %>
        ...
        <div class="col-md-10">
            <form name="documentAction" action="SharedDocuments.do" method="POST">
                <% if (model != null) {%>
                <input id="selectedAffinityDomain" name="selectedAffinityDomain" type="hidden"
                       value="<%= model.getSelectedAffinityDomain().getId()%>"/>
                <input id="demographic_no" name="demographic_no" type="hidden"
                        ...
                        <div class="panel-body">
                            <div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="<%= String.format("%s&selectedAffinityDomain=%s", submitUrl, domain.getId())%>"><%= domain.getName()%>
                                            </a></li>
                                        <% } %>
                                    </ul>
                                </div>
                            ...
                            <table class="table">
                                ...
                                <tr<%= (documentDiscloseWarning || documentImportWarning) ? " class=\"warning\"" : ""%>>
                                    ...
                                    <% if (!documentDiscloseWarning) {%>
                                    <td><%=doc.getCreationTime().toString()%>
                                    </td>
                                    <td><%=author%>
                                    </td>
                                    <td><%=doc.getMimetype()%>
                            ...
                            <div>
                                <input type="submit" class="btn btn-primary pull-left" name="downloadDocuments"
                                       value="Download"/>
                                <div class="pull-right">
                                    <% if (!model.getUnconsentedPolicies().isEmpty()) { %>
                                    <button type="button" id="consent" name="consent" class="btn btn-warning"
                                            data-toggle="modal" data-target="#consentModal">Consent
                                    </button>
                                    <% } %>
                                    <button type="button" id="elevate" name="elevate" class="btn btn-info"
                                            data-toggle="modal" data-target="#elevateModal">Elevate
                                    </button>
                                </div>
                ...
                <% if (!model.getUnconsentedPolicies().isEmpty()) {%>
                <!-- Consent Modal -->
                <div class="modal fade" id="consentModal" tabindex="-1" role="dialog" aria-labelledby="elevateLabel"
                     aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="authenticatorSelect" name="consentAuthenticatorSelect"
                                            class="form-control">
                                        <option value="<%= model.getDemographic().getDemographicNo()%>"><%= model.getDemographic().getDisplayName()%>
                                        </option>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group policy-group">
                                        ...
                                        <span class="input-group-addon"><a href="<%= policy.getPolicyDocUrl()%>"
                                                                           target="_blank">View Policy</a></span>
                                    </div>
                                    <% } %>
                                </div>
                            </div>
                ...
                <% }%>
                <!-- Elevate Modal -->
                <div class="modal fade" id="elevateModal" tabindex="-1" role="dialog" aria-labelledby="elevateLabel"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group policy-group">
                                    ...
                                    <select id="purposeOfUse" name="purposeOfUse" class="form-control">
                                        ...
                                        <option value="<%= codeValue.getCode()%>"><%= codeValue.getDisplayName()%>
                                        </option>
                                        <% }%>
                                    </select>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" id="dismissElevateModalButton" name="dismissElevateModalButton"
                                        class="btn btn-default" data-dismiss="modal">Cancel
                                </button>
                                <input type="submit" class="btn btn-primary pull-left" name="confirmElevate"
                                       value="Elevate"/>
                            </div>
                        </div>
                    </div>
