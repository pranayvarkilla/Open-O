            ...
            <div class="panel-body" id="clinicInfoForm">
                ...
                <div class="control-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="form_oid" name="form_oid" required
                               data-validation-required-message="This field is required"/>
                    </div>
                    <p class="help-block"></p>
                </div>
            ...
            <div class="panel-body">
                ...
                <div class="control-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="form_appname" name="form_appname" required
                ...
                <div class="control-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="form_facilityname" name="form_facilityname" required
                               data-validation-required-message="This field is required"/>
                    </div>
                    <p class="help-block"></p>
                </div>
                ...
                <div class="control-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="form_universal" name="form_universal" required
                               data-validation-required-message="This field is required"/>
                    </div>
                    <p class="help-block"></p>
                </div>
                ...
                <div class="control-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="form_namespace" name="form_namespace" required
                               data-validation-required-message="This field is required"/>
                    </div>
                    <p class="help-block"></p>
                </div>
            ...
            <div class="panel-body">
                ...
                <div class="control-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="form_source" name="form_source" required
                               data-validation-required-message="This field is required"/>
                    </div>
                    <p class="help-block"></p>
                </div>
