...
<html>
    <head>
        ...
        <script type="text/javascript" src="<c:out value="<%= request.getContextPath() %>/share/javascript/Oscar.js"/>"></script>
        <script type="text/javascript" src="<c:out value="<%= request.getContextPath() %>/share/javascript/prototype.js"/>"></script>
