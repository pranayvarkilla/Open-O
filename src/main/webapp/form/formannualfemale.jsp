                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left" nowrap="true"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formHeadNeck"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.fomrResp"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formCardio"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formSkin"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formMSK"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formEndocrin"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formOther"/>:
                            </td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td colspan="4"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.forReview"/>:
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                ...
                <td class="DashedBorder">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formSmoking"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formAlcohol"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formIllicitDrugs"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formNutrition"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formDentalHygiene"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td valign="top"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formRelationship"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td nowrap="true"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formSexualityRisks"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td nowrap="true"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formOccupationalRisks"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td nowrap="true"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formDrivingSafety"/>:
                            </td>
                        ...
                        <tr>
                            ...
                            <td nowrap="true"><bean:message
                                    key="oscarEncounter.formFemaleAnnual.formForeignTravel"/>:
                            </td>
        ...
        <table width="100%" class="tableWithBorder">
            ...
            <tr>
                ...
                <td align="right"><bean:message
                        key="oscarEncounter.formFemaleAnnual.formPulse"/>:
                </td>
                <td><input type="text" name="pulse" size="10" maxlength="10"
                           value="<%= props.getProperty("pulse", "") %>"/> /min
                </td>
                <td align="right"><bean:message
                        key="oscarEncounter.formFemaleAnnual.formHeight"/>:
                </td>
            ...
            <tr>
                ...
                <td align="right"><bean:message
                        key="oscarEncounter.formFemaleAnnual.formRhythm"/>:
                </td>
                <td><input type="text" name="rhythm" size="10" maxlength="10"
                           value="<%= props.getProperty("rhythm", "") %>"/></td>
                <td align="right"><bean:message
                        key="oscarEncounter.formFemaleAnnual.formUrineDipstick"/>:
                </td>
