                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" nowrap="true"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formHeadNeck"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formResp"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formCardio"/>:
                                        </td>
                            ...
                            <td>
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formSkin"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formMSK"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formEndocrin"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formOther"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formReview"/>:
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                ...
                                <table class="DashedBorder">
                                    <tr>
                                        ...
                                        <td><b><i><small>("<bean:message
                                                key="oscarEncounter.formMaleAnnual.msgAnyConcerns"/>")</small></i></b>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formSmoking"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formAlcohol"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formIllicitDrugs"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formNitrition"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><bean:message
                                                key="oscarEncounter.formMaleAnnual.formDentalHygiene"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formRelationship"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="true"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formSexualityRisks"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="true"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formOccupationalRisks"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="true"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formDrivingSafety"/>:
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="true"><bean:message
                                                key="oscarEncounter.formMaleAnnual.formForeignTravel"/>:
                                        </td>
                    ...
                    <table width="100%" class="tableWithBorder">
                        ...
                        <tr>
                            ...
                            <td align="right"><bean:message
                                    key="oscarEncounter.formMaleAnnual.formPulse"/>:
                            </td>
                            ...
                            <td align="right"><bean:message
                                    ...
                                    key="oscarEncounter.formMaleAnnual.msgWeightUnit"/>.
                            </td>
                        <tr>
                            <td>&nbsp;</td>
                            <td><bean:message key="oscarEncounter.formMaleAnnual.formBP"/>:
                            ...
                            <td align="right"><bean:message
                                    key="oscarEncounter.formMaleAnnual.formRythm"/>:
                            </td>
                            <td><input type="text" name="rhythm" size="10" maxlength="10"
                                       value="<%= props.getProperty("rhythm", "") %>"/></td>
                            <td align="right"><bean:message
                                    key="oscarEncounter.formMaleAnnual.formUrineDipstick"/>:
                            </td>
