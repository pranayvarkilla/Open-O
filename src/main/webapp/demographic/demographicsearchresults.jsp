    ...
    <div class="container">
        <div id="demographicSearch" style="margin-bottom: 10px;">
            ...
            <a href="javascript:void(0)" onclick="showHideItem('demographicSearch');" id="cancelButton"
               class="leftButton top"> <bean:message key="global.btnCancel"/> </a>
        ...
        <div id="searchResults">
            ...
            <i><bean:message key="demographic.demographicsearchresults.msgSearchKeys"/></i> : <c:out
                value="${param.keyword}"/>
            ...
            <table id="patientResults" class="table table-condensed table-striped table-responsive">
                <tr class="tableHeadings deep">
                    ...
                    <th class="dob"><a
                            ...
                            key="demographic.demographicsearchresults.btnDOB"/> <span class="dateFormat"><bean:message
                            key="demographic.demographicsearchresults.btnDOBFormat"/></span></a>
                    </th>
                    <th class="doctor"><a
            ...
            <caisi:isModuleLoad moduleName="caisi">
                <div class="goBackToSchedule">
                    <a href="../provider/providercontrol.jsp"
                       title="<bean:message key="demographic.search.btnReturnToSchedule" />">
