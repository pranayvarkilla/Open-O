                ...
                <form name="addtemplatecode1" method="post"
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        ...
                        <tr bgcolor="#CCFFCC">
                            <td nowrap>
                                <p><bean:message
                                        key="schedule.scheduleedittemplate.formProvider"/>: <%=request.getParameter("providername")%>
                                </p>
                            </td>
        ...
        <table width="95%" border="1" cellspacing="0" cellpadding="2"
            ...
            <tr bgcolor='ivory'>
                <td nowrap><bean:message
                        key="schedule.scheduleedittemplate.formTemplateName"/>:
                </td>
            ...
            <tr bgcolor='ivory'>
                <td><bean:message
                        key="schedule.scheduleedittemplate.formSummary"/>:
                </td>
