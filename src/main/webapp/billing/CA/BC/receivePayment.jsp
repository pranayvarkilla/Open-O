...
<c:if test="${receivePaymentActionForm.paymentReceived}">
    <fieldset>
        ...
        <div class="msgDisplay">
            ...
            <fmt:setBundle basename="oscarResources"/><fmt:message key="oscar.billing.CA.BC.credit"/> &nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscar.billing.CA.BC.invoice"/> <bean:write
                name="receivePaymentActionForm" property="billNo"/> &nbsp; <fmt:setBundle basename="oscarResources"/><fmt:message key="oscar.billing.CA.BC.lineNo"/> <bean:write
...
<c:if test="${not receivePaymentActionForm.paymentReceived}">
    <html:form action="/billing/CA/BC/receivePaymentAction">
        ...
        <fieldset>
            ...
            <div class="msgDisplay">
                <p><fmt:setBundle basename="oscarResources"/><fmt:message key="oscar.billing.CA.BC.invoice"/> <bean:write
                        name="receivePaymentActionForm" property="billNo"/></p>
                <p><fmt:setBundle basename="oscarResources"/><fmt:message key="oscar.billing.CA.BC.lineNo"/> <bean:write
            ...
            <p><label> <fmt:setBundle basename="oscarResources"/><fmt:message key="oscar.billing.CA.BC.method"/>
